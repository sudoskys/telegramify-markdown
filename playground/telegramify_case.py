...
get_config().markdown_symbol.head_level_1 = "📌"  # If you want, Customizing the head level 1 symbol
get_config().markdown_symbol.link = "🔗"  # If you want, Customizing the link symbol
